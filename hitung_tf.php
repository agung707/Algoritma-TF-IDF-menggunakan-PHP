...
$count_d3 = array_sum(array_map(function($val) use ($search) {if ($val == $search) { return 1; } else { return 0; }}, str_word_count($ketemu_d2, 1)));
...
$wdt3 = $count_d3 * $idf ;
echo"
<tr><td><a href=hapus_hasil_tf.php?id=$term_tf[id]><center>Hapus</center></a></td>
	...
	<td><textarea rows=1 cols=2 name=d3>$count_d3</textarea></td>
	...
	<td><textarea rows=1 cols=7 name=wdt3>$wdt3</textarea></td>
